...
import com.redhat.engineering.jenkins.report.plugin.utils.FormatUtil;
import com.redhat.engineering.jenkins.report.plugin.utils.GraphHelper;
...
public class MethodResult extends BaseResult {
   ...
   public String getDisplayDescription() {
     ReportPluginProjectAction projAction
        = super.getOwner().getProject().getAction(ReportPluginProjectAction.class);
