...
public class ReportPluginProjectAction implements Action {
    ...
    protected final Filter getInitializedFilter() {
    ...
    /**
     * Returns
     * <code>true</code> if there is a graph to plot.
     *
     ...
     * which will filter configurations (meaningful if we want results
     * aggregated only from some subset of all matrix runs).
     *
     * @param dataset
    ...
    /*
     * Updates private list <code>builds</code> used for populating
     * dataSetBuilder according to buildFilteringMethod.
     */
    ...
    /**
     * Returns true if configurations filtering method is set to
     * COMBINATIONFILTER (Combination Filter was submitted last time and now
     * should be checked)
     *
     * @return
     */
